...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"firetry.js":[function(require,module,exports) {
"use strict";
...
function _onFormSubmit() {
  _onFormSubmit = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var data;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 12:
            document.getElementById('employee-data').reset();
            document.getElementById('picture-upload').value = ""; //sortTableByName(1);
...
function _editData() {
  _editData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var firstName, lastName, email, gender, birthdate, employee, date;
...
function _getData() {
  _getData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var firstName, lastName, email, gender, birthdate, employee;
...
function addNewRow(x) {
  ...
  row.innerHTML = "<td><img src=\"".concat(x.picture, "\" /></td>\n        <td>").concat(x.firstName, " ").concat(x.lastName, "</td>\n        <td>").concat(x.email, "</td>\n        <td>").concat(x.gender, "</td>\n        <td>").concat(moment(date).format("D MMMM YYYY"), "</td>\n        <td>\n            <button class=\"btn btn-danger btn-extra\" onClick=\"deleteEmployee(this)\">Delete</button>\n            <button type=\"button\" class=\"btn btn-primary btn-extra\" onClick=\"editEmployee(this)\">Edit</button>\n        </td>");
...
function _deleteEmployee() {
  _deleteEmployee = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(td) {
...
function editEmployee(td) {
  row = td.parentElement.parentElement;
  console.log(row.id);
  db.doc(row.id).get().then(function (doc) {
    if (doc.exists) {
...
function filterGender() {
  ...
  if (gender != "null") {
    db.where("gender", "==", gender).get().then(function (querySnapshot) {
      querySnapshot.forEach(function (doc) {
        addNewRow(doc.data());
      });
      sortTableByName(1);
...
function filterPicture() {
  ...
  if (picture == "no-picture") {
    db.where("picture", "==", image).get().then(function (querySnapshot) {
      querySnapshot.forEach(function (doc) {
        addNewRow(doc.data());
      });
      sortTableByName(1);
...
function filterByDate() {
  ...
  if (startDate != null && endDate != null) {
    db.where("birthdate", ">=", startDate).where("birthdate", "<=", endDate).get().then(function (querySnapshot) {
      querySnapshot.forEach(function (doc) {
        addNewRow(doc.data());
      });
      sortTableByName(1);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","firetry.js"], null)
//# sourceMappingURL=/firetry.57300678.js.map